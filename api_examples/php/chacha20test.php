...
$Nonce = "AAAAAAAAAEoAAAAA";
$UseBase64 = true;
$InitialCounter = 1;

$message = "Ladies and Gentlemen of the class of '99: If I could offer you only one tip for the future, sunscreen would be it.";

$cipher_str = chacha20_encrypt($message,$Key,$Nonce,$UseBase64,$InitialCounter);
echo "cipher text: ".$cipher_str.PHP_EOL;

$plain_str = chacha20_decrypt($cipher_str,$Key,$Nonce,$UseBase64,$InitialCounter);
